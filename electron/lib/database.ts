...
function compactSessionForStorage(session: SessionRecord): SessionRecord {
  return {
    ...
    metadata: {
      ...
      codexThreadSource: session.metadata.codexThreadSource,
      codexForkedFromId: session.metadata.codexForkedFromId,
      codexParentThreadId: session.metadata.codexParentThreadId,
      codexAgentNickname: session.metadata.codexAgentNickname,
